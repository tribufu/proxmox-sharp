...
namespace ProxmoxSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateClusterFirewallGroupRuleRequest")]
    public partial class UpdateClusterFirewallGroupRuleRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateClusterFirewallGroupRuleRequest" /> class.
        /// </summary>
        ...
        public UpdateClusterFirewallGroupRuleRequest(string action = default(string), string comment = default(string), string delete = default(string), string dest = default(string), string digest = default(string), string dport = default(string), int enable = default(int), string icmpType = default(string), string iface = default(string), string log = default(string), string macro = default(string), int moveto = default(int), string proto = default(string), string source = default(string), string sport = default(string), string type = default(string))
        {
            this.Action = action;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateClusterFirewallGroupRuleRequest {\n");
