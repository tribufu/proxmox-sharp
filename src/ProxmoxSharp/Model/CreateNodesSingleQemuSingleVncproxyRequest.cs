...
namespace ProxmoxSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateNodesSingleQemuSingleVncproxyRequest")]
    public partial class CreateNodesSingleQemuSingleVncproxyRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNodesSingleQemuSingleVncproxyRequest" /> class.
        /// </summary>
        /// <param name="generatePassword">generatePassword.</param>
        /// <param name="websocket">websocket.</param>
        public CreateNodesSingleQemuSingleVncproxyRequest(bool generatePassword = default(bool), bool websocket = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "generate-password", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateNodesSingleQemuSingleVncproxyRequest {\n");
