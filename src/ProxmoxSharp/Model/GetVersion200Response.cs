...
namespace ProxmoxSharp.Model
{
    ...
    public partial class GetVersion200Response : IValidatableObject
    {
        ...
        public GetVersion200Response(List<string> errors = default(List<string>), GetVersion200ResponseData data = default(GetVersion200ResponseData))
        {
            this.Errors = errors;
            this.Data = data;
        }
        ...
        public GetVersion200ResponseData Data { get; set; }
