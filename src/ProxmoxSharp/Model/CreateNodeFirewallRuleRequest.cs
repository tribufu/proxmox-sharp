...
namespace ProxmoxSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateNodeFirewallRuleRequest")]
    public partial class CreateNodeFirewallRuleRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNodeFirewallRuleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateNodeFirewallRuleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNodeFirewallRuleRequest" /> class.
        /// </summary>
        ...
        public CreateNodeFirewallRuleRequest(string action = default(string), string comment = default(string), string dest = default(string), string digest = default(string), string dport = default(string), int enable = default(int), string icmpType = default(string), string iface = default(string), string log = default(string), string macro = default(string), int pos = default(int), string proto = default(string), string source = default(string), string sport = default(string), string type = default(string))
        {
            // to ensure "action" is required (not null)
            if (action == null)
            {
                throw new ArgumentNullException("action is a required property for CreateNodeFirewallRuleRequest and cannot be null");
            }
            this.Action = action;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for CreateNodeFirewallRuleRequest and cannot be null");
            }
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateNodeFirewallRuleRequest {\n");
